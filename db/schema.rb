...
ActiveRecord::Schema.define(version: 2020_08_04_090548) do
  ...
  create_table "songs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["composer_id", "composition_id", "title"], name: "index_songs_on_composer_id_and_composition_id_and_title", unique: true
